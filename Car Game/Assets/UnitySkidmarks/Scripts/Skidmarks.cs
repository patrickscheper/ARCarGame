...
public class Skidmarks : MonoBehaviour {
	...
	const float MARK_WIDTH = 0.2f; // Width of the skidmarks. Should match the width of the wheels
	const float GROUND_OFFSET = -0.1f;  // Distance above surface in metres
	const float MIN_DISTANCE = 0.3f; // Distance between skid texture sections in metres. Bigger = better performance, less smooth
